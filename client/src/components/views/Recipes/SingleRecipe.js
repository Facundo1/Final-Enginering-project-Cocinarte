  ...
  render() {
    ...
    return (
      <div>
        <div>
          <div className="d-flex justify-content-center">
            <h5 className="titleReceta rounded mt-3">
             {recipe.title}
            </h5>
          </div>
          <div className="d-flex justify-content-center">
          ...
          <div className="d-flex justify-content-center">
            <h5 className="titlePasos rounded mt-4 mb-3">
              Pasos
            </h5>
          </div>
          <div className="d-flex justify-content-center">
            <ul>
              {Steps.map((item, index) => {
                return (
                  <li className="text-left h5" key={index}>
                    {item}
                  </li>
                );
              })}
          ...
          <div className="d-flex justify-content-center">
            <h5 className="titleCategoria rounded">
          ...
          <div className="d-flex justify-content-center">
            {
              <Link to="/Recetas" id="btnVolver">
                <button className="mt-2 btn btn-danger  text-white rounded h5">
                  Volver
                </button>
              </Link>
            }
